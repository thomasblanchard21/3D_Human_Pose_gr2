...
dataset_direcotories = {"izar":"/work/scitas-share/datasets/Vita/civil-459/h3.6", #/home/rhossein/venvs/codes/VideoPose3D/data/
...
class H36_dataset(Dataset):
    ...
    def process_data(self, dataset , sample=sample, is_train = True, standardize = False, z_c = zero_centre) :
        ...
        if num_of_joints == 16: #Should throw an error if num of joints is 16 but zero centre is false    
...
if __name__ == "__main__" :
    ...
    all_in_one_dataset_2d, all_in_one_dataset_3d , video_and_frame_paths = H36_dataset.read_data(subjects=subjects[0:6]) #protocol 1: training on S1, S5, S6, S7, S8, S9
    ...
    all_in_one_dataset_2d, all_in_one_dataset_3d , video_and_frame_paths = H36_dataset.read_data(subjects=subjects[6:7]) #protocol 1: testing on S11
    for i in range(all_in_one_dataset_3d.shape[0]):
        all_in_one_dataset_3d[i,1:] = all_in_one_dataset_3d[i,1:] - all_in_one_dataset_3d[i,0]
        all_in_one_dataset_3d[i,0] *= 0 
